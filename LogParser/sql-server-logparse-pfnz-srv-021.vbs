...
' Date: 06/05/2011
	...
	cmd = chr(34) & exepath & "LogParser.exe " & chr(34) & " " & chr(34) & "SELECT EventLog, RecordNumber, TO_UTCTIME(TimeGenerated), EventID, EventType, EventTypeName, EventCategory, SourceName, ComputerName, Message FROM System, Application TO Events" & chr(34) &  " -o:SQL -server:192.168.50.229 -driver:" & chr(34) & "SQL Server" & chr(34) & " -database:CreateFormLogging -username:logcollector -password:dnaltocs -createtable:ON -iCheckPoint:c:\support\logparse_evtcheck_D.lpc"	
